...
public class FabricanteController {
    ...
    @Operation(
       summary = "Serviço responsável por listar um fabricante no sistema através do ID."
    )
    @GetMapping("/{id}")
    ...
    @Operation(
       summary = "Serviço responsável por deletar um fabricante no sistema através do ID."
    )
    @DeleteMapping("/{id}")
